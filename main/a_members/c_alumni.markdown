            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="item-student">
                    <div class="card card-profile">
                        <div class="card-header card-avatar">
                            <img class="img"
                                 src="/assets/images/members/고다혜.jpg"
                                 alt="Dahye Ko (고다혜)">
                        </div>
                        <div class="card-body">
        ...
        <div class="row wrapper-students">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="item-student">
                    <div class="card card-profile">
                        <div class="card-body">
                            <h4 class="card-title">Minyoung Kim(김민영)</h4>
                            <h6 class="card-category">Bachelor (2018)</h6>
                            <hr>
                            <ul>
                            </ul>
        ...
        <div class="row wrapper-students">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="item-student">
                    <div class="card card-profile">
                        <div class="card-body">
                            <h4 class="card-title">Namhun Kim(김남훈)</h4>
                            <h6 class="card-category">Bachelor (2014)</h6>
                            <hr>
                            <ul>
                                <li style="font-size: 1.1em"><b>취업</b>: 네이버</li>
        ...
        <div class="row wrapper-students">
                ...
                <div class="item-student">
                    <div class="card card-profile">
                        <div class="card-body">
                            ...
                            <h6 class="card-category">Bachelor (2008)</h6>
                            <hr>
                            <ul>
                                <li style="font-size: 1.1em"><b>취업</b>: (주)자이네스</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="item-student">
                    <div class="card card-profile">
                        <div class="card-body">
                            <h4 class="card-title">Gyungwon Seo(서경원)</h4>
                            <h6 class="card-category">Bachelor (2008)</h6>
                            <hr>
                            <ul>
                                <li style="font-size: 1.1em"><b>취업</b>: (주)쿼드디멘션스</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="item-student">
                    <div class="card card-profile">
                        <div class="card-body">
                            <h4 class="card-title">Sungjin No(노성진)</h4>
                            <h6 class="card-category">Bachelor (2008)</h6>
                            <hr>
                            <ul>
                                <li style="font-size: 1.1em"><b>취업</b>: (주)에스디엔</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="item-student">
                    <div class="card card-profile">
                        <div class="card-body">
                            <h4 class="card-title">Seongil Hyun(현승일)</h4>
                            <h6 class="card-category">Bachelor (2008)</h6>
                            <hr>
                            <ul>
                                <li style="font-size: 1.1em"><b>진학</b>: 한국기술교육대학교 대학원 석사과정</li>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="item-student">
                    <div class="card card-profile">
                        <div class="card-body">
                            <h4 class="card-title">Sangjun Park(박상준)</h4>
                            <h6 class="card-category">Bachelor (2008)</h6>
                            <hr>
                            <ul>
                                <li style="font-size: 1.1em"><b>취업</b>: 공무원</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                <div class="item-student">
                    <div class="card card-profile">
                        <div class="card-body">
                            <h4 class="card-title">Kiwoong Lee(이기웅)</h4>
                            <h6 class="card-category">Bachelor (2008)</h6>
                            <hr>
                            <ul>
                                <li style="font-size: 1.1em"><b>취업</b>: 대한상공회의소</li>
                            </ul>
                        </div>
                    </div>
                </div>
