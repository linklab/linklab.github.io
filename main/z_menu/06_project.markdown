                        ...
                        <section style="padding: 0px 0px; width:100%" class="content-wrapper">
                            ...
                            <article>
                                ...
                                <div class="panel article-content-1">
                                    ...
                                    <p>
                                        <strong>Federated Reinforcement Learning for Optimization of Intelligent Multi-IoT Devices Control in Edge Computing Environment [4차년도/총4년]</strong><br/>
                                        <strong>(에지 컴퓨팅 환경에서 지능형 멀티 IoT 디바이스 제어 최적화를 위한 연합 강화 학습)</strong><br/>
                                        - Duration: March. 1, 2023 ~ May 31, 2023<br/>
                                    ...
                                    <p>
                                        <strong>Interaction Virtual Reality based Immersive Training Platform [6차년도/총9년]</strong><br/>
                                        <strong>(상호작용 가상현실 기반 몰입형 교육 훈련 플랫폼)</strong><br/>
                                        - Duration: March. 1, 2023 ~ Feb. 28, 2024<br/>
                                        - Sponsor: National Research Foundation of Korea (NRF, 중점연구소지원사업)<br/>
                                        - Role: Researcher (참여연구원)
                            ...
                            <article>
                                ...
                                <div class="panel article-content-1">
                                    ...
                                    <table class="acknowledgement">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td>국문 - 이 논문은 2016년도 정부(미래창조과학부)의 재원으로 정보통신기술진흥센터의 지원을 받아 수행된 연구임 (No.B0717-16-0033,
                                                서비스/단말/네트워크 다양성 지원을 위한 미래형 다차원 네트워크 시스템 아키텍쳐)
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>영문 - This work was supported by Institute for Information &amp; communications
                                                Technology Promotion(IITP) grant funded by the Korea government(MSIP) (No.B0717-16-0033,
                                                Study on the multi-dimensional Future Network System Architecture for diversity of Services,
                                                Terminals and Networks)
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <p><strong>Development of Crawling and Big Data Analysis System for Large-Scale Scholarly Paper
                                        Information</strong><br/>
                                        <strong>(대용량 학술논문정보 수집 및 빅데이터 분석 시스템 개발)</strong><br/>
                                        - Duration: June 1, 2016 ~ Dec. 30, 2016<br/>
                                        - Sponsor: 산학협력 선도대학(LINC) 육성사업, National Research Foundation of Korea (NRF)<br/>
                                        - Role: Project manager (연구책임) </p>
                                    <table class="acknowledgement">
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody>
                                        <tr>
                                            <td>국문 - 본 과제(결과물)는 교육과학기술부의 재원으로 지원을 받아 수행된 산학협력 선도대학(LINC) 육성사업의 연구결과입니다.</td>
                                        </tr>
                                        <tr>
                                            <td>영문 - Following are results of a study on the &#8220;Leades INdustry-university
                                                Cooperation&#8221; Project, supported by the Ministry of Education, Science &amp; Technology
                                                (MEST)
                                            </td>
                                        </tr>
                                        </tbody>
                            ...
                            <article>
                                ...
                                <div class="panel article-content-1">
                                    <p><strong>Study on Routing and Scheduling Schemes Using Energy-Aware Social Network Analysis in
                                        Wireless Mobile Networks [3차년도/총3년]</strong><br/>
                                        <strong>(무선 이동 네트워크에서 에너지 인지적 사회관계망 분석을 이용한 라우팅 및 스케줄링 기법에 관한 연구)</strong><br/>
                                        - Duration: June 1, 2015 ~ May 30, 2016<br/>
                                        - Sponsor: National Research Foundation of Korea (NRF)<br/>
                                        - Role: Project manager (연구책임) </p>
                                    <table class="acknowledgement">
                                        <thead>
                                        ...
                                        <tbody>
                                        <tr>
                                            <td>국문 - 이 논문은 2013년도 정부(교육부)의 재원으로 한국연구재단의 지원을 받아 수행된 기초연구사업임 (No.
                                                NRF-2013R1A1A2010050)
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>영문 - This research was supported by Basic Science Research Program through the
                            ...
                            <article>
                                ...
                                <div class="panel article-content-1">
                                    <p><strong>Research and Implementation of Network-based IP Mobility Technology</strong><br/>
                                        ...
                                        - Role: Project manager (연구책임)</p>
                                    <br/>
                                    <p><strong>Study on Implementation of Mobile IPv4/IPv6 Integration</strong><br/>
                            ...
                            <article>
                                ...
                                <div class="panel article-content-1">
                                    ...
                                    <p><strong>IPv6 Mobility and IETF Standardization</strong><br/>
                                        <strong>(IPv6 이동성 및 IETF 국제 표준화)</strong><br/>
